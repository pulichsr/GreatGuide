...
{
  public class More2Panel : Control
  {
    public More2Panel()
    {
      this.Width = 480;
    ...
    private void Draw(Graphics g)
    {
      ...
      RectangleF StringBounds = new RectangleF(4, 0, 214, 114);
      ...
      StringBounds = new RectangleF(5, 118, 200, 20);
      g.DrawString(comment1Label + comment1, commentFont, brush, StringBounds);

      StringBounds = new RectangleF(5, 141, 200, 20);
