...
{
  partial class frmSelectMasterArea
  {
    /// <summary>
    ...
    private void InitializeComponent()
    {
      ...
      this.lblPrompt.Text = "Select Master Area";
      ...
      this.Name = "frmSelectMasterArea";
      this.Text = "frmDisclaimer";
      this.Load += new System.EventHandler(this.frmSelectMasterArea_Load);
