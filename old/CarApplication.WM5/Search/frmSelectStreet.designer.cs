namespace Nucleo.GoodGuide.CarApplication
{
  partial class frmSelectStreet
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.lblMainHeading.Text = "Select Street";
      ...
      this.Name = "frmSelectStreet";
      this.Text = "frmDisclaimer";
      this.Load += new System.EventHandler(this.frmSelectStreet_Load);
      this.Closing += new System.ComponentModel.CancelEventHandler(this.frmSelectStreet_Closing);
