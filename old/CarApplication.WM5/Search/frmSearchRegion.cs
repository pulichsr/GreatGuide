...
{
  public partial class frmSearchRegion : Form
  {
    public static DialogResult Search(ILogger logger, IRegionSearchDataProvider dataProvider, ref string initialSearchCriteria)
    {
      frmSearchRegion frm = new frmSearchRegion(logger,dataProvider, initialSearchCriteria);
    ...
    private frmSearchRegion(ILogger logger, IRegionSearchDataProvider dataProvider, string searchCriteria)
    {
...
*/
    ...
    private void DataChanged()
    {
      ...
      else
      {
        ...
        {
          edtStreet.Text = string.Format("{0}", dataProvider.Data[0].CollatedName);
