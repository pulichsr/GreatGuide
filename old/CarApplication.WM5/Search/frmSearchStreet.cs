...
{
  public partial class frmSearchStreet : Form
  {
    public static DialogResult Search(ILogger logger, IStreetSearchDataProvider dataProvider, ref string initialSearchCriteria)
    {
      frmSearchStreet frm = new frmSearchStreet(logger,dataProvider, initialSearchCriteria);
    ...
    private frmSearchStreet(ILogger logger, IStreetSearchDataProvider dataProvider, string searchCriteria)
    {
...
*/
    ...
    private void DataChanged()
    {
      ...
      else
      {
        ...
        {
          edtStreet.Text = string.Format("{0} : {1}", dataProvider.Data[0].Name, dataProvider.Data[0].RegionCollatedName);
