namespace Nucleo.GoodGuide.CarApplication
{
  partial class frmSelectDestination
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.lstItems.Columns.Add(column2);
      ...
      this.lblMainHeading.Text = "Select Destination";
      ...
      this.Load += new System.EventHandler(this.frmSelectDestination_Load);
      this.Closing += new System.ComponentModel.CancelEventHandler(this.frmSelectDestination_Closing);
