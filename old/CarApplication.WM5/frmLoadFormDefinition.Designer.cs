...
{
  partial class frmLoadFormDefinition
  {
    /// <summary>
    ...
    private void InitializeComponent()
    {
      ...
      this.label3.Text = "Current form definition file";
      // 
      // edtCurrentFile
      // 
      ...
      this.Name = "frmLoadFormDefinition";
      this.Text = "Load Data";
      this.Closing += new System.ComponentModel.CancelEventHandler(this.frmLoadFormDefinition_Closing);
      this.Load += new System.EventHandler(this.frmLoadFormDefinition_Load);
