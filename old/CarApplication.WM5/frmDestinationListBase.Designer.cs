...
{
  partial class frmDestinationListBase
  {
    /// <summary>
    ...
    private void InitializeComponent()
    {
      ...
      this.alData.HeaderClick += new Resco.Controls.AdvancedList.CellEventHandler(this.alData_HeaderClick);
      this.alData.ValidateData += new Resco.Controls.AdvancedList.ValidateDataEventHandler(this.alData_ValidateData);
      ...
      this.Name = "frmDestinationListBase";
      this.Text = "Destination List";
      this.Activated += new System.EventHandler(this.frmDestinationListBase_Activated);
      this.Load += new System.EventHandler(this.frmDestinationListBase_Load);
